...
class EngineBindingsTest(object):
    ...
    def engine_bindings(self):
        return str(sorted(cherrypy.engine.sqlalchemy.engine_bindings.viewitems(),
...
saconf = {'sqlalchemy_engine_blueberrypy.tests._test_plugins_engine_bindings.User':
          {'url': "sqlite://"},
          'sqlalchemy_engine_blueberrypy.tests._test_plugins_engine_bindings.Group':
          {'url': "sqlite://"}}
